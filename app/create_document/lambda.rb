...
module CreateDocument
  class Handler < EventHandler
    def handle(s3_client: Aws::S3::Client.new, document_repository: DocumentRepository)
      ...
      s3_object_key = "#{params['x-corellation-id']}/original/#{input_file.original_filename}"
      ...
      [422, id: params['x-corellation-id'], status: :error, message: e.message]
    ensure
